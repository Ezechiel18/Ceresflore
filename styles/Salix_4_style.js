...
var style_Salix_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 4.4 + size, points: 5,
            radius2: 2.2, stroke: new ol.style.Stroke({color: 'rgba(239,43,46,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(239,43,46,1.0)'})}),
