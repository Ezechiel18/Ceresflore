...
map.getView().fit([379676.393676, 5218238.144352, 831530.385575, 5622355.284648], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Localisation des interventions de Cérès Flore</h2>';
        return titleElement;
    })(),
